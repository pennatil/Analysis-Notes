...
#The following commmands will move the files to the Output folder. DO NOT ADD ANY UMLAUT TO THE NAMES, GIT GOES BANANAS!!!!
mv mainMult1.pdf "$BASEDIR/Output/Kapitel 1 - Logik und Unterlagen - Analysis I.pdf"
mv mainMult2.pdf "$BASEDIR/Output/Kapitel 2 - Reele Zahlen, Euklidische Raeume und Komplexe Zahlen - Analysis I.pdf"
...
mv mainMult7.pdf "$BASEDIR/Output/Kapitel 7 - Gewoehnliche Differenzialgleichungen - Analysis II.pdf"
...
{ # your 'try' block
	...
	echo "#### FINISHED GENERATING CHAPTER FILES, CAN BE FOUND IN THE OUTPUT FOLDER ####"
}
