...
\usepackage[T1]{fontenc}% Also for the Umlauts
\usepackage[swissgerman]{babel}%localized string of Chapter and other keywords
...
\usepackage[a4paper]{geometry}% Nicer geometry
...
\usetikzlibrary{decorations.markings} %Decoration for tikz lines, arrow in the middle of the line (Chapter 8)

\usepackage{textcomp}%Used for the degree symbol in chapter 9
