...
Die Richtung des Gradients ist somit \[ \nabla h\left( P \right) = \arctan{\frac{\frac{1}{5}}{\frac{\sqrt{2}}{4}+ \frac{1}{5}}}=19.86 °\]\todo{add arg at the beginning of the equation using special command, as well as tilde on top of equal sign}
