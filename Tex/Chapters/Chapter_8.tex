...
\draw[fill=white,color=white, very thick] (-2,1.385) -- (-2,3.865);
\draw[fill=white,color=white, very thick] (-2.005,1.39) -- (-2.005,3.865);
\draw[fill=white,color=white, very thick] (-1.995,1.385) -- (-1.995,3.865);
...
\end{enumerate}
Die Region $\Omega=\R\backslash\{ 0\}$ ist nicht einfach zu $\Omega' = \left\{ \left( x,y\right) \mid x>0\right\}$ ist es aber.\todo[inline]{This sentence doesn't make any sense at all}%DO NOT MODIFY THIS TODO AS IT MESSES UP FLOATS WHEN BUILDING
\end{definition}
