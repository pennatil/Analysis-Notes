...
In der Definition 5.1 verlangen wir also, dass für jede in $\Omega \backslash\{ x_0\}$ enthaltene Folge $\left( x_n\right)_{n\geq 1}$ mit Grenzwert $x_0$, der Limes \todo{limenet: formula on page 184 missing: lim of (f(x_n)-f(x_0))/(x_n-x_0) as n tends towards infinity}
