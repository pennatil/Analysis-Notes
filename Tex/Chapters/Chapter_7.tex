...
\noindent Ist die Störfunktion z.B. ein Polynom, so nimmt man an, dass die spezielle Lösung auch ein Polynom sein wird. Ist die Störfunktion eine Exponentialfunktion so nimmt man an, dass die Lösung auch eine Exponentialfunktion sein wird.
