...
Unter dem Voraussetzungen von Satz 5.29\todo{Add reference} ist $f(x)=\sum\limits_{n=0}^\infty a_nx^n$ in $C^\infty\left( -\rho, \rho\right)$ und die Ableitungen von $f$ erhält man durch Gliedweises differenzieren. 
...
Das bedeutet, dass wenn $x$ nähe bei $a$ ist, $R_mf(x;a)$ klein ist im Vergleich zu der schon sehr kleinen Grösse $(x-a)^m$. Für den Restterm $R_mf(x;a)$, haben wir die abschätzung \todo{not sure where the additional content goes, page 240 middle}
