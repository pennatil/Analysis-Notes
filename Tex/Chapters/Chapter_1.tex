...
\subsubsection*{Beweis}
Nehmen wir das Gegenteil ``$\mathbb{P}$ ist endlich'' an, d.h. $\mathbb{P}=\{p_1,p_2,\dots,p_m\}$ n aufsteigender Folge; also $p_1=2,p_2=3,p_3=5,p_4=7,\dots$. Wir betrachten die Zahl $k=p_1\dots p_{m+1}$. Auf Satz 1.4 folgt dass so eine Primzahl $p_i$ (aus der liste $p_1\dots p_{m}$) gilt mit $p_i$ teilt $k$. Da $p_i$ offensichtlich $p_1\dots p_{m}$ teilt, folgt dass $p_i$ $k-p_1\dots p_{m}=1$ teilt. Das ist ein Widerspruch. 
