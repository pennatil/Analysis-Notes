...
\[ = \frac{{b - a}}{n}\sum\limits_{i = 0}^{n - 1} {(f({x_{i + 1}}) - f({x_i}))} \] \[ = \frac{{b - a}}{n}(f(b) - f(a)) < \varepsilon \]
...
Dies Formel bedeutet folgenden: Die Linke Seite als Funktion von $x$ ist gleich der rechten Seite als Funktion von $t$ vermöge der Relation \[x=g(t)\]
\[dx=g'(t)dt\]
...
mit $x=au$, $dx=adu$ \[F=4\int ^{1}_{0}b\sqrt {1-u^2}adu\]
\[=4ab\int ^{1}_{0}\sqrt {1-u^2}du\] mit $u=\sin t$, $du=\cos tdt$
\[4ab\int ^{\pi /2}_{0}\sqrt {1-\sin^2t}\cos t dt\]
\[=4ab\int ^{\pi /2}_{0}\cos ^{2}tdt=\left.\frac{4ab}{2}\left( t+\sin t\cos t\right) \right| ^{\pi /2}_{0}\] \[=\pi ab\]
\end{enumerate}  
...
Ansatz: \[R(x)=\frac{a_1}{x}+\frac{a_2}{x^2}+\frac{b_1x+d_1}{x^2+1}\]
