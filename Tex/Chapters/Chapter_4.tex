...
\item Aus wiederholter Anwendung von 1. und 2. ergibt sich die Polynomfunktion:
...
\end{minipage}
\end{figure}
\item Die folgenden Funktionen sind auf ihrem Definitionsbereich stetig:
\begin{figure}[htpb]
...
$\Omega \subset \R^{d}, f:\Omega\to\R^{n}, x_{0}\in\R^{d}\setminus\Omega$ so dass $\exists (x_{k})\in\Omega$ mit $\lim{x_{k}=x_{0}}$. \\
